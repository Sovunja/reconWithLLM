...
# Все три тула — Go-нативные, без CGO, ставятся через go install.
# Никаких готовых бинарников и Chromium больше не нужно.
# ============================================================
...
# ============================================================
# Стадия 2: сборка нашего приложения (ядро + модули).
# ============================================================
